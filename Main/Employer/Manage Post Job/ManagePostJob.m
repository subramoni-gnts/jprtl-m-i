...
#import "ManagePostJob.m"

@interface ManagePostJob ()

@end

@implementation ManagePostJob
...
int menuCheckCountManagePostJob=1;


- (void)viewDidLoad
{
    [super viewDidLoad];
    menuCheckCountManagePostJob=1;
...
-(IBAction)menuButton:(id)sender
{
    ...
    if (menuCheckCountManagePostJob==1)
    {
